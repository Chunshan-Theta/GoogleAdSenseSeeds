    ...
    <>
      ...
      <div className="fire-container">
        ...
        <div className="intro-text">
          ...
          轉換跑道時，心裡的疑問是：「這步棋走下去，會後悔嗎？」<br /><br />
          沒人能預測未來。面對人生變動，支撐決策的，是帳戶餘額。存款數字，是選擇的底氣。<br /><br />
          把未知轉換成數據。我動手寫了一套系統，計算三個問題：<br /><br />
          現有存款，能撐起手上的選擇嗎？<br /><br />
          按照現有收入與儲蓄率，距離目標還有幾年幾個月？<br /><br />
          到了幾歲，我可以停止存錢，將籌碼用來承擔風險？<br /><br />
        </div>
